...
#define CH224Q_MODE_UNKNOWN             (0)   //No Mode Selected, default state after power-on
#define CH224Q_MODE_CTRL_5V_BIT         (1)  //Bit 4: Set this bit to request 5V from the Power-Source. Works with PD, QC2, QC3 and BC Protocols
#define CH224Q_MODE_CTRL_9V_BIT         (2)  //Bit 5: Set this bit to request 9V from the Power-Source. Works with PD, QC2, QC3 Protocols
#define CH224Q_MODE_CTRL_12V_BIT        (4) //Bit 6: Set this bit to request 12V from the Power-Source. Works with PD, QC2, QC3 Protocols
#define CH224Q_MODE_CTRL_15V_BIT        (8) //Bit 7: Set this bit to request 15V from the Power-Source. Works with PD and QC3 Protocols
#define CH224Q_MODE_CTRL_20V_BIT        (16) //Bit 8: Set this bit to request 20V from the Power-Source. Works with PD and QC3 Protocols
#define CH224Q_MODE_CTRL_28V_BIT        (32) //Bit 9: Set this bit to request 28V from the Power-Source. Works with EPR (Extended Power Range) PD Protocols
#define CH224Q_MODE_CTRL_PPS_MODE_BIT   (64) //Bit 10: Set this bit to enable PPS-Mode (Programmable Power Supply) if supported by the Power-Source. Requires PD3.x Protocol
#define CH224Q_MODE_CTRL_AVS_MODE_BIT   (128) //Bit 11: Set this bit to enable AVS-Mode (Adjustable Voltage Supply) if supported by the Power-Source. Requires PD3.2 Protocol